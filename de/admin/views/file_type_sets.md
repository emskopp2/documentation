...
Informationen wie sie **Dateityp-Sets** weiterverarbeiten, z.B. über die Vererbung, erhalten sie im Kapitel [Kategorien](views/categories.md#kategorieeinstellungen) im Abschnitt **Kategorieeinstellungen** --> Erlaubte Dateitypen
